...
const Navbar = () => {
  ...
  return (
    <header className="bg-main lg:px-20 lg:py-0 p-2 Neue  w-full z-10 ">
      ...
      {showCloseIcon && (
        <div className=" h-full w-full bg-main py-5 flex flex-col justify-center items-center gap-9 z-10">
